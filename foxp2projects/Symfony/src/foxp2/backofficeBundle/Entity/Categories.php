 ...
 * })
 * @ORM\Entity(repositoryClass="foxp2\backofficeBundle\Entity\CategoriesRepository")
 */
class Categories
{
    /**
    ...
    /**
     *
     * @ORM\OneToMany(targetEntity="foxp2\backofficeBundle\Entity\Categories", mappedBy="parentId",cascade={"remove"})  
     * 
     */
    private $children;
     ...
     * Add children
     *
     * @param \foxp2\backofficeBundle\Entity\Categories $children
     * @return Categories
     */
    public function addChildren(\foxp2\backofficeBundle\Entity\Categories $children)
    {
     ...
     * @param \foxp2\backofficeBundle\Entity\Categories $children
     */
    public function removeChildren(\foxp2\backofficeBundle\Entity\Categories $children)
    {
     ...
     * Set parentId
     *
     * @param \foxp2\backofficeBundle\Entity\Categories $parentId
     * @return Categories
     */
    public function setParentId(\foxp2\backofficeBundle\Entity\Categories $parentId = null)
    {
