 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="foxp2\projectsBundle\Entity\ArticlesRepository")
 */
class Articles
{
    /**
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="foxp2\projectsBundle\Entity\Categories")
     ...
     * @var string
     *
     * @ORM\Column(name="article_short_description", type="string", length=255)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="article_long_description", type="string", length=255)
     */
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="article_date_modified", type="datetime")
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="article_gist_reference", type="integer")
     */
     ...
     * Set category
     *
     * @param \foxp2\projectsBundle\Entity\Categories $category
     * @return Articles
     */
    public function setCategory(\foxp2\projectsBundle\Entity\Categories $category = null)
    {
