...
use foxp2\projectsBundle\Form\EventListener\CategoriesDateSubscriber;
...
class CategoriesType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(            
            'data_class' => 'foxp2\projectsBundle\Entity\Categories',            
        ));
    }
    ...
    {
        return 'foxp2_projectsbundle_categoriestype';
    }
}
